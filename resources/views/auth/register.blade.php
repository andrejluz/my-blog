...
@section('title', 'Užsiregistruoti')

@section('content')
<div class="container pt-5 pb-5">
    <div class="row justify-content-center login-page-table pt-5 pb-5">
        <div class="col-md-8">
            <div class="card ">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Pakartoti Slaptažodi') }}</label>
