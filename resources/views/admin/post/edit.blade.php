...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Redaguoti straipsni : {{ $post['title'] }}</h1>
        </div>
      </div><!-- /.row -->
                <!-- Success message -->
            ...
            <form action="{{ route('post.update', $post['id']) }}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text"  name="title"class="form-control" id="exampleInputEmail1" placeholder="Iveskyte pavadinima" value="{{ $post['title'] }} " required>
                </div>
                <div class="form-group">
                    <div class="form-group">
                      <label>Kategorijos</label>
                      <p>Straipsnio kategorija : {{ $post->category['title'] }} </p>
                ...
                <div class="form-group">
                  <form method="post">
                    <textarea  name="text" rows="25" class="editor"> {{ $post['text'] }} </textarea>
                  </form>
                </div>
