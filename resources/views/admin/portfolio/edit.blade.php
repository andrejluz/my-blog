...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Redaguoti portfolio įraša : {{ $portfolio['title'] }}</h1>
        </div>
      </div><!-- /.row -->
                <!-- Success message -->
            ...
            <form action="{{ route('portfolio.update', $portfolio['id']) }}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text"  name="title"class="form-control" id="exampleInputEmail1" placeholder="Iveskyte pavadinima" value="{{ $portfolio['title'] }} " required>
                </div>
                <div class="form-group">
                    <div class="form-group">
                ...
                <div class="form-group">
                  <form method="post">
                    <textarea  name="text" rows="25" class="editor"> {{ $portfolio['text'] }} </textarea>
                  </form>
                </div>
                ...
                <div class="form-group mt-3">
                  ...
                  <input type="text" id="feature_image" name="img" value="{{ $portfolio['img'] }}" class="form-control" readonly>
