...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Visos mano portfolio ( {{ $portfolios_count }})</h1>
        </div>
      </div><!-- /.row -->
            <!-- Success message -->
    ...
    <div class="container-fluid">
        {{-- <div class="row"> --}}
            ...
            <div class="form-group d-flex justify-content-arround">
                ...
                <a href="{{ route('coding.create') }}" class="btn btn-primary ml-5">Sukurti portfolio</a> 
              </div>
                <div class="card">
                        ...
                        <tbody id="table-container">
                            ...
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    <a class="btn btn-info btn-sm" href="{{ route('portfolio.edit', $portfolio['id']) }}">
